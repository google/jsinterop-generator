...
flags
    ...
    .option('--bean_convention', 'Use java bean convention for generated '
        + 'getters and setters')
    .option('--dependency_mapping_file <file>',
        ...
        __collect, [])
    .option('--integer_entities_file <file>',
        'File containing the list of entities typed as number and need to be '
        + 'converted to integer instead of double. The entity is represented '
        + 'by its fqn.',
        __collect, [])
    .parse(process.argv);
